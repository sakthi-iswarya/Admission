...
if(isset($_POST['Submit']))
{
    ...
    $msg=mysqli_query($con,"insert into add_branch(branch_name,amount) 
  ...
  <body>
    <section id="container" >
        <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Add Branch</b></a>
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Add Branch</h3>
                <div class="row"> 
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <div style="margin-left:100px; padding-bottom:20px;" >
                                <input type="submit" name="Submit" value="Add Branch" class="btn btn-theme" style="color:white;
