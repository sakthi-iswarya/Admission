...
<html lang="en">
  ...
  <body>
    ...
    <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Admission Report </b></a>
        ...
        <section id="main-content">
            <section class="wrapper">
          	    <h3><i class="fa fa-angle-right"></i> Admission Report</h3>
				<div class="row">  
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="delete-data.php?mid=<?php echo $row['adm_id'];?>"> 
