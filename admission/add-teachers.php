...
if(isset($_POST['Submit']))
{
    ...
    $msg=mysqli_query($con,"insert into add_teachers(t_name,t_email,t_mobile,t_dept,salary,date) 
          values('$t_name','$t_email','$t_mobile','$t_dept','$salary','$date')");
  ...
  <body>
    <section id="container" >
        <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Add Teachers</b></a>
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Add Teachers</h3>
                <div class="row"> 
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Teacher Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="t_name" value="" >
                                </div>
                            </div>
    
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Teacher Email</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="t_mobile" value="" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name='t_dept' style="padding:7px;">  
                                    <option value="<?php echo $row_list['branch_name'];?>">Department</option> 
                                    <?php  
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Salary</label>
                                <div class="col-sm-10">
                            ...
                            <div style="margin-left:100px; padding-bottom:20px;" >
                                <input type="submit" name="Submit" value="Add Teacher" class="btn btn-theme" style="color:white;
