...
{
$adminid=$_GET['tid'];
$msg=mysqli_query($con,"delete from add_teachers where tid='$adminid'");
if($msg)
{
...
<html lang="en">
  ...
  <body>
    ...
    <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Teachers Report </b></a>
        ...
        <section id="main-content">
            <section class="wrapper">
          	    <h3><i class="fa fa-angle-right"></i> Teachers Report</h3>
				<div class="row">  
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <tbody>
                                <?php $ret=mysqli_query($con,"select * from add_teachers");
							        $cnt=1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="update-report.php?sid=<?php echo $row['tid'];?>"> 
                                    <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                                    <a href="delete-report.php?sid=<?php echo $row['tid'];?>"> 
